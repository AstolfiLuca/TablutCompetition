...
/**
 * Defines the weight keys for Black player heuristics.
 * This class ensures type safety and prevents typos when accessing weights.
 */
public class BlackWeights {
    ...
    private BlackWeights() {
        throw new AssertionError("Cannot instantiate BlackWeights");
    }
    ...
    public static Map<String, Double> mergeWithDefaults(Map<String, Double> providedWeights) {
        Map<String, Double> merged = BlackWeights.getDefaultWeights();
