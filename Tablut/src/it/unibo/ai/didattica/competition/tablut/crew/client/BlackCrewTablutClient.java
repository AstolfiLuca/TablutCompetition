...
public class BlackCrewTablutClient {

	public static void main(String[] args) throws UnknownHostException, ClassNotFoundException, IOException {
		// role, name, timeout, ip, gameVariant, debug
		String[] arguments = new String[]{"BLACK", "Crew", "50", "localhost", "0", "debug"}; // default arguments

        if(args.length > 0) arguments = new String[]{"BLACK", args[0]}; // custom arguments
