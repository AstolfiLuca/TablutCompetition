...
if [[ "$ROLE_LOWER" == "white" ]]; then
    ...
    HEURISTICS=ls -{"KING_THREAT_WEIGHT": 4.0,"KING_SAFETY_WEIGHT": 4.0,"KING_INCHECK_WEIGHT": 3.0,"MANHATTAN_TOKING_WEIGHT": 14.0,"MANHATTAN_TOESCAPES_WEIGHT": 0.0,"LINE_SCORE_WEIGHT": 7.0,"PAWNS_SAFETY_WEIGHT": 10.0,"PAWNS_THREAT_SCORE_WEIGHT": 7.0,"PIECES_SCORE_WEIGHT": 78.0,"DEFENSIVE_POSITION_WEIGHT": 0.0,"RHOMBUS_SCORE_WEIGHT": 14.0}'
else
